...
cities = {
    "москва": ["1540737/de3af311f4646cae2ed0", "1540737/12dfce02d1fb20be8dd2"],
    "нью-йорк": [
        "1540737/f99727e0c267b3935cd4",
        "965417/e9e43c8eb73c94778342",
    ],
    "париж": ["1521359/ad2457138d64b031c55a", "1030494/69cb67294257e527e971"],
}
    ...
    if attempt == 1:
        ...
        if get_city(req) == city:
            ...
            if attempt == 3:
                ...
                res["response"]["card"][
                    "title"
                ] = "Неправильно. Вот тебе дополнительное фото"
                res["response"]["card"]["image_id"] = cities[city][attempt - 1]
